...
//--------------------------------------------------
    ...
    if(isset($_POST['submit'])){
      $a=$_POST['c_name'];
      $f=$_POST['c_place'];
        $sql="update type_post
        set  t_name='$a',t_des='$f'
        where t_id=$t;
        ";
        // echo $sql;
     ...
     $sql="select * from type_post where t_id=$t";
    //  echo $sql;
     $result=mysqli_query($conn,$sql);
...
<h4 class="m-3 text-center">Sửa thể loại</h4>
...
<form  action="edit.php" method="post" >
  <div class="form-group mt-2">
    ...
    <input type="text" class="form-control" name="c_name" aria-describedby="emailHelp" value="<?php echo $r["t_name"] ?>" required>
  </div>
<div class="form-group mt-2">
    <label for="exampleInputEmail1">Mô tả</label>
    <input type="text" class="form-control" name="c_place" aria-describedby="emailHelp" value="<?php echo $r['t_des'] ?>" required>
  </div>
