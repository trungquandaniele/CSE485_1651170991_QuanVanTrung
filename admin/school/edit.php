...
//--------------------------------------------------
    ...
    if(isset($_POST['submit'])){
      ...
      $t=$_SESSION['edich'];
      $sql="update school
      set  s_name='$name',s_description='$des' ,s_place='$place',s_date1='$date1',s_date2='$date2',s_title='$title'
      where s_id=$t";
    //   }else{
    //     $t=$_SESSION['edicom'];
    //     $sql="update users
    ...
    //   }
     ...
     //hien thi du lieu
     $t=$_SESSION['edich'];
     $sql="select * from school where s_id=$t";
     $result=mysqli_query($conn,$sql);
...
<h4 class="m-3 text-center">Sửa thông tin trường học</h4>
