...
//--------------------------------------------------
    ...
    //   $t=$_SESSION['edicom'];
      $sql="insert into company (c_name,c_description,c_place,c_date1,c_date2)
      values  ('$name','$des','$place','$date1','$date2')";
    //   }else{
    //     $t=$_SESSION['edicom'];
    //     $sql="update users
...
<h4 class="m-3 text-center">Thêm công ty đã làm việc</h4>
